...
# Files
WEATHER_STATION_LIST_PATH = 'src/utils/datasets/weather-stations-list.csv'
WEATHER_PARAMETERS_LIST_PATH = 'src/utils/datasets/api-clim-table-parametres-quotidiens.csv'
